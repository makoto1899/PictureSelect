...
{
    partial class VersionDialog : Form
    {
        ...
        {
            System.Diagnostics.Process.Start("mailto:makoto@dive-in.to");
        }

        private void linkHP_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("http://hamaguchi.yokohama/");
        }
